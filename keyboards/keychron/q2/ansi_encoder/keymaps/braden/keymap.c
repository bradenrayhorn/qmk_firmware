...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_67(
        B_TESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
    ...
    switch (keycode) {
        case B_TESC:
            if (record->event.pressed) {
                ...
                uint8_t shift_mod = mods & MOD_MASK_SHIFT;
                if (shift_mod) {
                    // have to remove shift modifier first, otherwise the backtick will turn into a tilde
